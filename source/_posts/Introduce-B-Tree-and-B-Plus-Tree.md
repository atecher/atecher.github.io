...
{% asset_img Introduce-B-Tree-and-B-Plus-Tree-1.png %}
...
的演示动画：
 ...
 {% asset_img Introduce-B-Tree-and-B-Plus-Tree-2.gif %}
...
{% asset_img Introduce-B-Tree-and-B-Plus-Tree-3.png %}

下图是B+树的插入动画：

 {% asset_img Introduce-B-Tree-and-B-Plus-Tree-4.gif %}
...
{% asset_img Introduce-B-Tree-and-B-Plus-Tree-5.png %}
...
{% asset_img Introduce-B-Tree-and-B-Plus-Tree-6.png %}
...
{% asset_img Introduce-B-Tree-and-B-Plus-Tree-7.png %}
...
{% asset_img Introduce-B-Tree-and-B-Plus-Tree-8.png %}
...
{% asset_img Introduce-B-Tree-and-B-Plus-Tree-9.png %}
